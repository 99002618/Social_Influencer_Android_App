...
public class NotificationInfluencer {
    String CampaignID;
    ...
    public  NotificationInfluencer(){

    }
    public NotificationInfluencer(String campaignID, String influencerName, String notificaionType, String campaign_Name, String from) {
